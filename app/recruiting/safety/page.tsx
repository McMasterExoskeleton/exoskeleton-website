...
export default function SafetyPage() {
  return (
    <div className="min-h-screen bg-charcoal text-softWhite py-12 px-4 flex flex-col items-center">
      <h1 className="text-5xl font-bold mb-6 text-dustyRose">Safety Subteam</h1>
      <div className="max-w-2xl text-center mb-12">
        <p className="mb-6 text-xl">
          The Safety subteam ensures safe practices, risk assessment, and the
          well-being of all team members during design, build, and testing.
        </p>
        <p className="mb-6 text-xl text-gray-300">
          [Add more details about the team's protocols, training, and safety
          initiatives here.]
        </p>
      </div>
      <div className="w-full max-w-xl bg-black bg-opacity-60 rounded-lg p-8 mt-4">
        <h2 className="text-3xl font-semibold text-dustyRose mb-4">
          Example Roles
        </h2>
        <ul className="list-disc list-inside text-left text-xl text-softWhite">
          <li>Risk Assessment Lead</li>
          <li>Workshop Safety Officer</li>
